...
//modified by Weipeng Wei, if you want to run the codes, it is better to change
// the build directory, also the directory of loading and saving generated mazes.
