...
public:
    ...
    void load(std::string _filename)
    {
      ...
      else im = cv::imread("/home/ecn/ecn_arpro/maze/mazes/mazess/"+filename, cv::IMREAD_GRAYSCALE);
    ...
    void save()
    {
        cv::imwrite("/home/ecn/ecn_arpro/maze/mazes/mazess/m4.png", im);
        display("Maze", im);
    }
    ...
    void saveSolution(std::string suffix)
    {
        ...
        cv::imwrite("/home/ecn/ecn_arpro/maze/mazes/mazess/" + name, out);
